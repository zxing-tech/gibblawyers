            ...
            <Card className="p-8 md:p-12 backdrop-blur-sm bg-card/50 border border-border/50 shadow-2xl">
              <div className="space-y-8">
                <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
                  <p>
                    Gibb & Co是马来西亚历史最悠久的事务所之一，其历史可追溯至1892年，该事务所始创于其创始合伙人阿尔弗雷德·蒙塔古·吉布（Alfred Montagu Gibb）乘坐英国的一艘英国船抵达槟城马来亚海岸，他于1892年在怡保成立了吉布公司（Gibb & Co)，1906年退休时，阿什沃思·霍普（Ashworth Hope）接任合伙人，并将公司名称更名为Gibb & Hope，直到1930年代中期，他回到英国，其余合伙人又恢复为Gibb & Co的原始名称。
                  </p>
                  
                  <p>
                    作为马来西亚前端最佳信誉的其中一家公司, Gibb & Co 在各地办事处都拥有最好的人员提供坚定踏实的各类法律服务并专注于客户与合作伙伴关系。
                  </p>
