...
const Services = () => {
  ...
  return (
    <Layout 
      ...
      description="Comprehensive legal services in Malaysia: Corporate & Commercial Law, Litigation & ADR, Real Estate, Employment Law, Family Law, Banking & Finance. Expert lawyers with 130+ years of experience in Ipoh."
    >
